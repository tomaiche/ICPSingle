...
module "deployVM_singlenode" {
  source = "git::https://github.com/tomaiche/ICPModules/vmware_provision"
...
module "push_hostfile" {
  source               = "git::https://github.com/tomaiche/ICPModules/config_hostfile"
...
module "icphosts" {
  source                = "git::https://github.com/tomaiche/ICPModules/config_icphosts"
...
module "icp_prereqs" {
  source               = "git::https://github.com/tomaiche/ICPModules/config_icp_prereqs"
...
module "icp_download_load" {
  source                 = "git::https://github.com/tomaiche/ICPModules/config_icp_download"
...
module "icp_config_yaml" {
  source                 = "git::https://github.com/tomaiche/ICPModules/config_icp_boot_standalone"
